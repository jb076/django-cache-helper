...
class BasicCacheTestCase(TestCase):
    def test_function_cache(self):
        x = foo(1, 2)
        self.assertTrue('tests.foo:12(1,2)' in cache)
...
class MultipleCallsDiffParamsTestCase(TestCase):
    ...
    def test_class_method(self):
        ...
        self.assertTrue("tests.Fruit.add_sweet_letter:44('a',)" in cache)
        self.assertTrue("tests.Fruit.add_sweet_letter:44('c',)" in cache)
